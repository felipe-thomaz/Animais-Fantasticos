export default class AnimaNumeros {
  ...
  // Recebe um elemento do DOM, com número em seu innerText. É feito o incremento deste número partindo do 0 até seu número final
  ...
  // Função que executa quando a mutação ocorrer
